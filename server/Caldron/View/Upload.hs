...
data UploadWizard = UploadWizard User

instance ToHtml UploadWizard where
  toHtml (UploadWizard user) = html_ $ do
    head_ $ do
    ...
    body_ $ do
      ...
      div_ [classes_ ["container", "mt-4"]] $ do
        ...
        div_ [id_ "page-1"] $ do
          ...
          div_ [class_ "d-flex"] $ do
            button_ [ id_ "single-file-btn"
              ...
              div_ [class_ "upload-choice-icon"] "\x1f4c4"
              div_ "Single File"
            button_ [ id_ "dir-file-btn"
                    , type_ "button"
                    , classes_ ["btn", "btn-outline-primary", "upload-choice-btn"]
                    ] $ do
              div_ [class_ "upload-choice-icon"] "\x1f4c1"
          ...
          div_ [class_ "row"] $ do
            ...
            div_ [class_ "col-md-4"] $ do
              ...
              div_ [class_ "form-group"] $ do
                ...
                textarea_ [id_ "wizard-description", class_ "form-control", rows_ "3", placeholder_ "Optional description"] ""
              div_ [class_ "form-group"] $ do
                label_ "Subjects"
        ...
        div_ [id_ "page-3", style_ "display:none"] $ do
          ...
          a_ [id_ "done-btn", href_ "/", class_ "btn btn-primary mt-3"] "Done"
...
wizardCss =
  ...
  \ overflow: hidden; }\
  \.file-preview-box img { max-width: 100%; max-height: 560px; object-fit: contain; }\
  \.file-preview-box iframe { width: 100%; height: 560px; border: 0; }\
  \.file-preview-box pre { max-height: 560px; overflow: auto; padding: 0.5rem;\
